...
class MixDehazeNet(nn.Module):
    ...
    def forward_features(self, x):
        x = self.patch_embed(x)       # torch.Size([1, 24, 256, 256])
        x = self.layer1(x)            # torch.Size([1, 24, 256, 256])
        skip1 = x

        x = self.patch_merge1(x)      # torch.Size([1, 48, 128, 128])
        x = self.layer2(x)           # torch.Size([1, 48, 128, 128])
        skip2 = x

        x = self.patch_merge2(x)      # torch.Size([1, 96, 64, 64])
        x = self.layer3(x)           # torch.Size([1, 96, 64, 64])
        x = self.patch_split1(x)     # torch.Size([1, 48, 128, 128])

        x = self.fusion1([x, self.skip2(skip2)]) + x   # torch.Size([1, 48, 128, 128])
        x = self.layer4(x)           # torch.Size([1, 48, 128, 128])
        x = self.patch_split2(x)     # torch.Size([1, 24, 256, 256])

        x = self.fusion2([x, self.skip1(skip1)]) + x   # torch.Size([1, 24, 256, 256])
        x = self.layer5(x)            # torch.Size([1, 24, 256, 256])
        x = self.patch_unembed(x)     # torch.Size([1, 4, 256, 256])
