...
from .base import Encoder_MDCBlock1, Decoder_MDCBlock1
...
class MSBDN_DFF(nn.Module):
    def __init__(self, res_blocks=18):
        super(MSBDN_DFF, self).__init__()
...
class MSBDN_RDFF(nn.Module):
    def __init__(self, res_blocks=18):
        super(MSBDN_RDFF, self).__init__()
        self.conv_input = ConvLayer(3, 16, kernel_size=11, stride=1)
        self.dense0 = nn.Sequential(
            ResidualBlock(16),
            ResidualBlock(16),
...
if __name__=="__main__":
    from pyzjr.nn.tools import summary_1, summary_2
    net = MSBDN_RDFF()
    summary_2(net, (3, 224, 224))